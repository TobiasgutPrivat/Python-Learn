...
API_BASE = "https://disp.yxl.ch/api/patients"
...
def api_get_all():
    ...
    """
    return handle_response(requests.get(API_BASE))
...
def api_get(pid):
    ...
    """
    return handle_response(requests.get(f"{API_BASE}/{pid}"))
...
def api_create(name, age):
    ...
    """
    return handle_response(requests.post(API_BASE, json={"name": name, "age": age}))
...
def api_update(pid, name, age):
    ...
    """
    return handle_response(requests.put(f"{API_BASE}/{pid}", json={"name": name, "age": age}))
...
def api_delete(pid):
    ...
    """
    return handle_response(requests.delete(f"{API_BASE}/{pid}"))
